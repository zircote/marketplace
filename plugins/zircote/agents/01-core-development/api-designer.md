...
- **Complete API surface**: Hold entire OpenAPI specs and GraphQL schemas in context
- **Cross-service awareness**: Track API dependencies across microservices ecosystem
